...
export const translations: Record<Language, TranslationDictionary> = {
  ...
  en: {
    ...
    testSosTrigger: 'Simulate Emergency SOS',
    ...
    viewOnGoogleMaps: 'Open Map Location',
  ...
  fr: {
    ...
    testSosTrigger: 'Simuler un SOS d\'Urgence',
    ...
    viewOnGoogleMaps: 'Ouvrir la Position GPS',
  ...
  sw: {
    ...
    testSosTrigger: 'Jaribu Simu ya Dharura ya SOS',
    ...
    viewOnGoogleMaps: 'Fungua Eneo Kwenye Ramani',
